...
>
> 6) Необходимо разрешить всё, что находится в разделе **Другие разрешения** (ярлыки рабочего стола, экран блокировки, открывать новые окна в фоновом режиме, отображение всплывающих окон).
>
> 7) Рекомендуется разрешить все уведомления.

**Первые шесть пунктов являются обязательными для стабильного обновления календаря в фоновом режиме.**
