...
>
> В разделе **Батарея** выберите режим **Не ограничивать** (Unrestricted).
>
> Выключите тумблер **Приостановить работу приложения если оно не используется**.
>
> В разделе **Разрешения приложений** выключите тумблер **Приостановить работу в неактивный период**.
>
> Рекомендуется разрешить всё, что находится в разделе **Другие разрешения** (ярлыки рабочего стола, экран блокировки, открывать новые окна в фоновом режиме, отображение всплывающих окон).
>
> Рекомендуется разрешить все уведомления.
